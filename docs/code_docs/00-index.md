...
| 28 | [Insights](28-insights.md) | Real screen time from `UsageStatsManager`: the pure `computeDailyStats` fold (distraction time, pickups, context switches, top apps), the 90-day `usage_daily` rollup, and the Insights segment of the Activity tab |
